...
int nvhost_module_get_rate(struct nvhost_module *mod, unsigned long *rate, int index);
int nvhost_module_set_rate(struct nvhost_module *mod, void *priv, unsigned long rate, int index);
